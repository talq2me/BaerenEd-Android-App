...
PROFILE_SUBS = {
    "AM": [
        ("englishWordsBM.json", "englishWordsAM.json"),
        ("englishWordsTE.json", "englishWordsAM.json"),
        ("frenchWordsBM.json", "frenchWordsAM.json"),
        ("frenchWordsTE.json", "frenchWordsAM.json"),
        ("spellingDragEnBM.json", "spellingDragEnAM.json"),
        ("spellingDragFrBM.json", "spellingDragFrAM.json"),
        ("poolKey=engSpellingDragPractice", "poolKey=engSpellingDrag"),
        ("poolKey=frSpellingDragPractice", "poolKey=frSpellingDrag"),
    ],
    "BM": [
        ("englishWordsAM.json", "englishWordsBM.json"),
        ("englishWordsTE.json", "englishWordsBM.json"),
        ("frenchWordsAM.json", "frenchWordsBM.json"),
        ("frenchWordsTE.json", "frenchWordsBM.json"),
        ("spellingDragEnAM.json", "spellingDragEnBM.json"),
        ("spellingDragFrAM.json", "spellingDragFrBM.json"),
        ("poolKey=engSpellingDragPractice", "poolKey=engSpellingDrag"),
        ("poolKey=frSpellingDragPractice", "poolKey=frSpellingDrag"),
    ],
    "TE": [
        ("englishWordsAM.json", "englishWordsTE.json"),
        ("englishWordsBM.json", "englishWordsTE.json"),
        ("frenchWordsAM.json", "frenchWordsTE.json"),
        ("frenchWordsBM.json", "frenchWordsTE.json"),
        ("spellingDragEnBM.json", "spellingDragEnAM.json"),
        ("spellingDragFrBM.json", "spellingDragFrAM.json"),
        ("poolKey=engSpellingDragPractice", "poolKey=engSpellingDrag"),
        ("poolKey=frSpellingDragPractice", "poolKey=frSpellingDrag"),
